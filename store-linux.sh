...
java -cp "$AXIS2CP:dist/highscoreservice-api.jar" -Dorg.apache.commons.logging.Log=org.apache.commons.logging.impl.NoOpLog -Ddebug.messages=true se.umu.cs.edu.jap.highscoreservice.StoreClient $@
