...
java -cp "$AXIS2CP:dist/highscoreservice-api.jar" -Dorg.apache.commons.logging.Log=org.apache.commons.logging.impl.NoOpLog -Ddebug.messages=true se.umu.cs.edu.jap.highscoreservice.StoreClient $1 $2 $3 $4 $5 $6 $7 $8 $9
